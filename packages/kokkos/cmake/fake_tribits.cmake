...
IF(KOKKOS_HAS_TRILINOS)
  ...
  TARGET_INCLUDE_DIRECTORIES(${${PROJECT_NAME}_LIBRARY_NAME_PREFIX}${TARGET} ${INCTYPE}
...
FUNCTION(KOKKOS_LIB_COMPILE_DEFINITIONS TARGET)
  #prefix is empty unless in tribits
  KOKKOS_TARGET_INCLUDE_DIRECTORIES(${${PROJECT_NAME}_LIBRARY_NAME_PREFIX}${TARGET} ${INCTYPE} ${ARGN})
